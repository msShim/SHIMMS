...
class Gra2MoreViewController: UIViewController, UIPickerViewDelegate, UITableViewDelegate,UITableViewDataSource, UITextFieldDelegate{
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "Gra2StarCell", for: indexPath) as! Gra2TableViewCell
    ...
    @IBAction func submit(_ sender: UIButton) {
        ...
        ServerManager.sendScore(star: self.starData, text: self.textfield.text!, cafeID: "3")
